              ...
              <div className="p-2 space-y-1">
                {filteredConversations.map(conv => (
                  <div
                    ...
                    className={`group p-4 rounded-xl cursor-pointer transition-all relative ${activeConversation?.id === conv.id
                ...
                {messages.map((msg, i) => {
                  ...
                  return (
                    <div key={i} className={`flex ${isVisitor ? 'justify-start' : 'justify-end'} animate-in slide-in-from-bottom-2 duration-300`}>
                      <div className={`max-w-[75%] rounded-[20px] px-4 py-3 shadow-sm relative group ${isVisitor
